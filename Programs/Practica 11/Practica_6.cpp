...
AUTOR: Josue Macias Castillo, Daniel Aguilar Gonzales, Agustin Galindo Reyes (C) Diciembre 2016
VERSIÓN: 1.0

DESCRIPCIÓN: Implementar el algoritmo de codificación de Huffman para codificar archivos de texto bajo lenguaje C.
• Implementar codificación voraz de Huffman
• Implementar el algoritmo de decodificación

OBSERVACIONES:

COMPILACIÓN: gcc Practica_6.c -o "Nombre del ejecutable"
...
int main(void)
{
	...
	do
	{
		...
		printf("1.- Codificacion de texto\n");
		printf("2.- Decodificacion de texto\n");
		printf("3.- Salir\n");
...
Obervaciones: el nombre de archivo debe acompañarse de su extensión. Ej: "archivo1.txt"
*/
int Codificar(char *in,char *out)
{
...
Descripción: Actualiza la cuenta de frecuencia del carácter c.
			 ...
			 ya sea por que la lista esté vacía, o porque el nuevo elemento sea el primero */
void Cuenta(tipoNodo* &Lista, char c)
{
   tipoNodo *p, *a, *q;
...
/*tipoTabla *BuscaCaracter(tipoTabla *Tabla, char c);
Descripción: Buscar un caracter en la tabla, devielve un puntero al elemento de la tabla */
tipoTabla *BuscaCaracter(tipoTabla *Tabla, char c)
{
   tipoTabla *t;
